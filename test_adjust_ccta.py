...
if __name__ == "__main__":
    ...
    # exec_time = timeit.timeit("mm.build_adjacency_map(mesh.faces.tolist())", globals=globals(), number=10)
    # print(f"Adjacency map build time over 10 runs: {exec_time:.4f} seconds")
