...
if __name__ == "__main__":
    ...
    print("+_+_+_+_+_+_+_+_+_+_+_+_+__+_+_+_+_+_+_+_+_+__")
    print(rest.geom_a.frames[0].lumen)
    ...
    print("+_+_+_+_+_+_+_+_+_+_+_+_+__+_+_+_+_+_+_+_+_+__")
    print(aligned.geom_a.frames[0].lumen)
    ...
    aortic_scaling = find_aorta_scaling(
        frames=aligned.geom_a.frames,
    ...
    scaled_anomalous = scale_region_centerline_morphing(
        ...
        centerline=rca_centerline,
        diameter_adjustment_mm=-0.9033,  # Enough shrinking for the visualization
    )
