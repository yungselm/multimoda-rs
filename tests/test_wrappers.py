...
def test_full_file_arr_consistency(
    ...
    assert len(rest_f.dia_geom.catheter) == len(rest_a.dia_geom.catheter)
    assert len(rest_f.sys_geom.catheter) == len(rest_a.sys_geom.catheter)
    ...
    assert len(stress_f.dia_geom.catheter) == len(stress_a.dia_geom.catheter)
    assert len(stress_f.sys_geom.catheter) == len(stress_a.sys_geom.catheter)
    ...
    assert len(dia_f.dia_geom.catheter) == len(dia_a.dia_geom.catheter)
    assert len(dia_f.sys_geom.catheter) == len(dia_a.sys_geom.catheter)
    ...
    assert len(sys_f.dia_geom.catheter) == len(sys_a.dia_geom.catheter)
    assert len(sys_f.sys_geom.catheter) == len(sys_a.sys_geom.catheter)
