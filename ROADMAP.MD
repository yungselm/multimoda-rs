...
- [] Shrink/Expand CCTA to best match aortic wall
...
(- [] better error propagation from Rust to Python (probably in the binding module, handle different python errors)?)
