...
- [] use the cleanup_section_points() also on LCA points
...
- [] make a dev version with more testing data in data folder and a minimal dataset for the pypi package, that can be loaded instead of read from files.
